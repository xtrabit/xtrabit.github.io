    ...
    <div className='backdrop bio' />
      ...
      />
        ...
        <p>
          ...
          moving parts were a part of my daily routine. Started to rebuild engines when I
        ...
        <p>
          ...
          there is much fun to be had in solving logistical problems.
        </p>
        <p>
          ...
          restrain myself from driving designs smaller and smaller until I could no longer work
        ...
        <p>
          &emsp;I would not claim to be talented, and like all humans, have my shortcomings. I like
